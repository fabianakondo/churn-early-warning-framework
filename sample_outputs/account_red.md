# Risk Assessment — Rede Norte Educação
### 🔴 Red | Score: 62 / 72 | Generated: October 2025
...
This is one of the highest-risk profiles possible within this framework. 
Five signals are at maximum score (3), and the account is in the final 
year of its contract term with no renewal conversation initiated and no 
executive relationship with the new decision-maker. The combination of 
leadership transition, competitive activity, and CS disengagement at this 
stage of the campaign calendar makes this account critically at risk of 
confirmed non-renewal within 30–45 days if no intervention occurs.
...
with a single renewal conversation. The last attempt was deflected in August 
with "wait until things settle." Two months have passed with no follow-up 
from the school and no re-engagement from the CS team. At this point in the 
calendar, a score of 2 should be treated as 3 — this account is effectively 
in non-renewal posture until proven otherwise.

**Signal 10 — Contract term stage (score: 3, weight: 2 — contribution: 6/6 pts)**
Final year of a 3-year contract, compounded by active risk signals on 
Signals 1, 8, and 12. This is not a rollover renewal — it is a full 
competitive procurement decision. The school has every structural incentive 
to evaluate alternatives, and a competitor has already presented. The 
final-year compounding rule applies: this signal is scored 3, not 2.

---

## 3. Intervention recommendation

This account requires an immediate executive intervention, not a CSM-led 
recovery. The following sequence must be executed within 48 hours.
...
This account cannot be recovered at CSM level. The risk is compounded 
across four independent dimensions (relationship, commercial, organisational, 
and contract stage), the contract value is material, and the reputational 
stakes extend beyond this single account. CS leadership and commercial 
leadership must be jointly accountable for the outcome from this point forward.

---

## 5. Watch list

**Event 1 — Superintendent responds to outreach (next 10 days)**
If the superintendent responds positively to executive outreach within 
10 days, the risk tier can be reassessed to Amber pending the outcome 
of the introductory call. If there is no response within 10 days, 
...
be asked in the next CSM touchpoint regardless of the executive 
outreach timeline.
